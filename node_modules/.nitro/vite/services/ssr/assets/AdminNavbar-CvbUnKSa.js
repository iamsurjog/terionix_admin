import { r as logout } from "./auth-B7ki30i8.js";
import { useState } from "react";
import { useLocation, useNavigate } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
//#region src/components/AdminNavbar.tsx
	...
	return /* @__PURE__ */ jsxs("nav", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsx("div", { className: "w-px h-8 bg-primary/20" }),
						/* @__PURE__ */ jsxs("div", {
							className: "flex items-center gap-2",
							children: [/* @__PURE__ */ jsx("div", { className: "w-2 h-2 rounded-full bg-accent motion-preset-pulse" }), /* @__PURE__ */ jsx("span", {
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						links.map((link) => link.type === "dropdown" && link.children ? /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("button", {
								...
								children: [/* @__PURE__ */ jsx("span", { children: link.name }), /* @__PURE__ */ jsx("svg", {
								...
								children: /* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx("div", { className: "absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-primary/20 via-secondary/20 to-accent/20" }), link.children.map((child) => /* @__PURE__ */ jsx("a", {
										href: `/admin${child.to}`,
										...
										children: /* @__PURE__ */ jsxs("span", {
											className: "flex items-center gap-2",
											children: [/* @__PURE__ */ jsx("span", { className: `w-1 h-1 rounded-full transition-all ${location.pathname === `/admin${child.to}` ? "bg-primary scale-150" : "bg-transparent"}` }), child.name]
										})
									}, child.name))]
								})
							})]
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("button", {
						...
						children: /* @__PURE__ */ jsxs("div", {
							...
							children: [
								/* @__PURE__ */ jsx("span", { className: `block h-0.5 w-full bg-current rounded-full transition-all duration-300 ${open ? "rotate-45 translate-y-[7px]" : ""}` }),
								/* @__PURE__ */ jsx("span", { className: `block h-0.5 w-full bg-current rounded-full transition-all duration-300 ${open ? "opacity-0" : ""}` }),
								/* @__PURE__ */ jsx("span", { className: `block h-0.5 w-full bg-current rounded-full transition-all duration-300 ${open ? "-rotate-45 -translate-y-[7px]" : ""}` })
							]
						})
					})]
			...
			children: /* @__PURE__ */ jsxs("div", {
				...
				children: [
					links.map((link) => /* @__PURE__ */ jsx(AdminMobileDropdownItem, {
						link,
						active,
...
function AdminMobileDropdownItem({ link, active, onClose }) {
	...
	if (link.type !== "dropdown" || !link.children) return /* @__PURE__ */ jsx("a", {
		href: `/admin${link.to}`,
		onClick: onClose,
	...
	return /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs("button", {
		...
		children: /* @__PURE__ */ jsx("div", {
			...
			children: link.children.map((child) => /* @__PURE__ */ jsx("a", {
				href: `/admin${child.to}`,
				onClick: onClose,
