import { t as contentAction } from "./content-XYN0YFXN.js";
import { t as Route } from "./json-DGUQ-gy0.js";
...
//#region src/routes/admin/json.tsx?tsr-split=component
function AdminJson() {
			...
			children: /* @__PURE__ */ jsxs("div", {
				...
				children: [
						...
						children: [/* @__PURE__ */ jsxs("div", { children: [
							...
							children: [
								...
								/* @__PURE__ */ jsx("button", {
									onClick: handleCopy,
									className: "flex items-center gap-2 px-4 py-2.5 rounded-xl border border-primary/20 bg-white/40 hover:bg-white/60 hover:border-primary/30 transition-all text-sm font-medium",
									children: copied ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx("svg", {
									...
									}), "Copied!"] }) : /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx("svg", {
										className: "w-4 h-4",
										fill: "none",
										stroke: "currentColor",
										viewBox: "0 0 24 24",
					...
					msg && /* @__PURE__ */ jsxs("div", {
						...
						children: [msg.type === "success" ? /* @__PURE__ */ jsx("svg", {
					...
					editing ? /* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								children: [
									/* @__PURE__ */ jsx("span", { className: "w-3 h-3 rounded-full bg-error/80" }),
									/* @__PURE__ */ jsx("span", { className: "w-3 h-3 rounded-full bg-warning/80" }),
									/* @__PURE__ */ jsx("span", { className: "w-3 h-3 rounded-full bg-success/80" }),
									/* @__PURE__ */ jsx("span", {
...
function highlightJson(line) {
	...
	if (/^[{}\[\],]*$/.test(trimmed)) return /* @__PURE__ */ jsx("span", {
	...
	if (strMatch) {
		...
		return /* @__PURE__ */ jsxs(Fragment, { children: [indentation && /* @__PURE__ */ jsx("span", {
			className: "text-white/20",
			children: indentation
		}), /* @__PURE__ */ jsxs("span", {
			className: "text-json-string",
	...
	if (boolMatch) return /* @__PURE__ */ jsxs(Fragment, { children: [indentation && /* @__PURE__ */ jsx("span", {
		className: "text-white/20",
		children: indentation
	}), /* @__PURE__ */ jsx("span", {
	...
	if (numMatch) return /* @__PURE__ */ jsxs(Fragment, { children: [indentation && /* @__PURE__ */ jsx("span", {
		className: "text-white/20",
		children: indentation
	}), /* @__PURE__ */ jsx("span", {
	...
	return /* @__PURE__ */ jsx("span", { children: line });
}
//#endregion
