import { a as writeSection, i as Textarea, n as Field, r as Input, t as AdminSection } from "./AdminSection-CjrmhaXe.js";
import { t as Route } from "./learn-CVqI8Pu1.js";
...
//#region src/routes/admin/learn.tsx?tsr-split=component
function AdminLearn() {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx(AdminNavbar, {
			...
			children: (values, onChange) => /* @__PURE__ */ jsxs(Fragment, { children: [
				/* @__PURE__ */ jsxs("div", {
				...
				values.moduleList.map((_, i) => /* @__PURE__ */ jsxs("div", {
				...
				values.whatIsEwaste.sections.map((s, i) => /* @__PURE__ */ jsxs("div", {
					className: "p-4 bg-white/50 rounded-lg border border-primary/10 space-y-2 mb-3",
					children: [
						/* @__PURE__ */ jsxs("div", {
							className: "text-xs text-text/50 font-medium uppercase tracking-wide",
						...
						(s.type === "text" || s.type === "callout") && /* @__PURE__ */ jsx(Field, {
							label: "Body",
							children: /* @__PURE__ */ jsx(Textarea, {
								value: s.body,
						...
						s.type === "callout" && /* @__PURE__ */ jsx(Field, {
							label: "Emoji",
							children: /* @__PURE__ */ jsx(Input, {
								value: s.emoji,
						...
						(s.type === "grid" || s.type === "list") && s.items && /* @__PURE__ */ jsxs("div", {
							...
							}), s.items.map((item, ii) => /* @__PURE__ */ jsxs("div", {
						...
						s.type === "stats" && s.stats && /* @__PURE__ */ jsxs("div", {
							className: "mt-3 pt-3 border-t border-dashed border-primary/10",
							children: [/* @__PURE__ */ jsxs("div", {
								className: "text-xs text-text/50 font-medium mb-2",
								children: [
							...
							}), s.stats.map((stat, si) => /* @__PURE__ */ jsxs("div", {
								className: "p-3 bg-white/60 rounded-lg border border-primary/10 space-y-1.5 mb-2",
								children: [/* @__PURE__ */ jsxs("div", {
									className: "text-[11px] text-text/40 font-mono",
									children: ["Stat ", si + 1]
						...
						s.type === "timeline" && s.steps && /* @__PURE__ */ jsxs("div", {
							className: "mt-3 pt-3 border-t border-dashed border-primary/10",
							children: [/* @__PURE__ */ jsxs("div", {
								className: "text-xs text-text/50 font-medium mb-2",
								children: [
							...
							}), s.steps.map((step, ti) => /* @__PURE__ */ jsxs("div", {
								className: "p-3 bg-white/60 rounded-lg border border-primary/10 space-y-1.5 mb-2",
								children: [
									/* @__PURE__ */ jsxs("div", {
										className: "text-[11px] text-text/40 font-mono",
				...
				values.hiddenValue.sections.map((s, i) => /* @__PURE__ */ jsxs("div", {
					className: "p-4 bg-white/50 rounded-lg border border-primary/10 space-y-2 mb-3",
					children: [
						/* @__PURE__ */ jsxs("div", {
							className: "text-xs text-text/50 font-medium uppercase tracking-wide",
				...
				values.environmentalImpact.sections.map((s, i) => /* @__PURE__ */ jsxs("div", {
					className: "p-4 bg-white/50 rounded-lg border border-primary/10 space-y-2 mb-3",
					children: [
						/* @__PURE__ */ jsxs("div", {
							className: "text-xs text-text/50 font-medium uppercase tracking-wide",
						...
						(s.type === "list" || s.type === "grid") && s.items && /* @__PURE__ */ jsxs("div", {
							className: "mt-3 pt-3 border-t border-dashed border-primary/10",
							children: [/* @__PURE__ */ jsxs("div", {
								className: "text-xs text-text/50 font-medium mb-2",
								children: [
				...
				values.theProcess.sections.map((s, i) => /* @__PURE__ */ jsxs("div", {
					className: "p-4 bg-white/50 rounded-lg border border-primary/10 space-y-2 mb-3",
					children: [
						/* @__PURE__ */ jsxs("div", {
							className: "text-xs text-text/50 font-medium uppercase tracking-wide",
						...
						s.type === "text" && /* @__PURE__ */ jsx(Field, {
							label: "Body",
							children: /* @__PURE__ */ jsx(Textarea, {
								value: s.body,
				...
				values.quiz.questions.map((_, i) => /* @__PURE__ */ jsxs("div", {
					className: "p-4 bg-white/50 rounded-lg border border-primary/10 space-y-2 mb-3",
					children: [
						/* @__PURE__ */ jsxs("div", {
							className: "text-xs text-text/50 font-medium uppercase tracking-wide",
				...
				values.takeAction.sections.map((s, i) => /* @__PURE__ */ jsxs("div", {
					className: "p-4 bg-white/50 rounded-lg border border-primary/10 space-y-2 mb-3",
					children: [
						/* @__PURE__ */ jsxs("div", {
							className: "text-xs text-text/50 font-medium uppercase tracking-wide",
						...
						s.type === "list" && s.items && /* @__PURE__ */ jsxs("div", {
							className: "mt-3 pt-3 border-t border-dashed border-primary/10",
							children: [/* @__PURE__ */ jsxs("div", {
								className: "text-xs text-text/50 font-medium mb-2",
								children: [
				...
				values.takeAction.pledge.commitments.map((_, i) => /* @__PURE__ */ jsxs("div", {
					className: "p-4 bg-white/50 rounded-lg border border-primary/10 space-y-2 mb-3",
					children: [/* @__PURE__ */ jsxs("div", {
						className: "text-xs text-text/50 font-medium uppercase tracking-wide",
