...
import { t as Route } from "./home-Qa4qAy22.js";
...
//#region src/routes/admin/home.tsx?tsr-split=component
function AdminHome() {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx(AdminNavbar, {
			...
			children: (values, onChange) => /* @__PURE__ */ jsxs(Fragment, { children: [
				...
				/* @__PURE__ */ jsx("hr", { className: "border-primary/10" }),
				/* @__PURE__ */ jsx("h3", {
					className: "font-semibold text-primary text-sm uppercase tracking-wider",
				...
				values.matrixCards?.map((card, i) => /* @__PURE__ */ jsxs("div", {
				...
				values.trustStats?.map((stat, i) => /* @__PURE__ */ jsxs("div", {
				...
				values.audience?.segments?.map((segment, i) => /* @__PURE__ */ jsxs("div", {
					className: "p-4 bg-white/50 rounded-lg border border-primary/10 space-y-2",
					children: [
						/* @__PURE__ */ jsxs("div", {
							className: "text-xs text-text/50 font-medium uppercase tracking-wide",
				...
				/* @__PURE__ */ jsxs("div", {
					...
					}), values.impactCalculator?.items?.map((item, i) => /* @__PURE__ */ jsxs("div", {
						className: "grid grid-cols-3 gap-3 p-3 bg-white/50 rounded-lg border border-primary/10",
						children: [
							/* @__PURE__ */ jsx(Field, {
								label: "Name",
