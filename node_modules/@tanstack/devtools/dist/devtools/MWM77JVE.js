...
var _tmpl$19 = ["<div", "><div", ">", "</div><div", "><div", ">", "<div", "><span", ">", "</span><span", ">", "</span></div></div><div", ">", "</div>", "", "</div>", "</div>"];
var _tmpl$210 = ["<img", ' alt="favicon icon"', ">"];
var _tmpl$37 = ["<div", "></div>"];
var _tmpl$46 = ["<div", ">", "</div>"];
var _tmpl$55 = ["<div", "><strong>Issues for ", ":</strong><ul", ">", "</ul></div>"];
var _tmpl$64 = ["<li", ">", "</li>"];
...
var _tmpl$20 = ["<nav", ' aria-label="SEO sections"><button type="button" class="', '">Social previews</button><button type="button" class="', '">SERP Preview</button></nav>'];
var SeoTab = () => {
  ...
  return createComponent(MainPanel$1, {
    withPadding: true,
    get children() {
      return [ssr(_tmpl$20, ssrAttribute("class", escape(styles().seoSubNav, true), false), `${escape(styles().seoSubNavLabel, true)} ${activeView() === "social-previews" ? escape(styles().seoSubNavLabelActive, true) : ""}`, `${escape(styles().seoSubNavLabel, true)} ${activeView() === "serp-preview" ? escape(styles().seoSubNavLabelActive, true) : ""}`), createComponent(Show, {
        get when() {
...
var _tmpl$211 = ['<button type="button"', ">", "</button>"];
var _tmpl$38 = ['<div style="', '"><button type="button"', ">", '</button><button type="button"', ">", "</button></div>"];
var Tabs = (props) => {
  const styles = useStyles();
  const {
    state,
  ...
  return ssr(_tmpl$21, ssrAttribute("class", escape(styles().tabContainer, true), false), escape(createComponent(For, {
    each: tabs,
    children: (tab) => ssr(_tmpl$211, ssrAttribute("class", escape(clsx3(styles().tab, {
      active: state().activeTab === tab.id
    }), true), false), escape(tab.icon()))
  })), pipWindow().pipWindow !== null ? escape(null) : ssr(_tmpl$38, ssrStyleProperty("margin-top:", "auto") + ssrStyleProperty(";width:", "100%"), ssrAttribute("class", escape(clsx3(styles().tab, "detach"), true), false), escape(createComponent(PiP, {})), ssrAttribute("class", escape(clsx3(styles().tab, "close"), true), false), escape(createComponent(X, {}))));
};
...
var TabContent = (props) => {
  ...
  return ssr(_tmpl$30, ssrAttribute("class", escape(styles().tabContent, true), false), escape(component()?.({
    isOpen: props.isOpen
  })));
};
var _tmpl$31 = ['<div style="', '">', "</div>"];
var _tmpl$212 = ['<div style="', '"></div>'];
var SourceInspector = () => {
  const {
    settings
  } = useDevtoolsSettings();
  ...
  return [ssr(_tmpl$31, ssrStyle({
    ...fileNameStyles(),
    "pointer-events": "none"
  }), escape(highlightState.dataSource)), ssr(_tmpl$212, ssrStyle({
  ...
  return createComponent(ThemeContextProvider, {
    ...
    get children() {
      return createComponent(Portal, {
        ...
        get children() {
          return ssr(_tmpl$39, ssrAttribute("data-testid", escape(TANSTACK_DEVTOOLS, true), false), escape(createComponent(Show, {
            get when() {
