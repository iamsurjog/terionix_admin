...
import { r as updatePassword } from "./content-XYN0YFXN.mjs";
import { N as require_jsx_runtime, P as require_react, g as useNavigate } from "../_libs/@tanstack/react-router+[...].mjs";
import { a as writeSection, n as Field, t as AdminSection } from "./AdminSection-CjrmhaXe.mjs";
import { t as isAuthenticated } from "./auth-B7ki30i8.mjs";
import { t as AdminNavbar } from "./AdminNavbar-CvbUnKSa.mjs";
import { t as Route } from "./settings-BL76RKY7.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/settings-SJpJ6Gh3.js
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
				...
				children: [
					...
					message && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						...
						children: [message.type === "success" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AdminSection, {
						...
						children: (values, onChange) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "p-4 bg-white/50 rounded-lg border border-primary/10 space-y-3",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
									className: "font-medium text-sm text-primary",
								...
								Array.isArray(values.links) && values.links.map((link, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Field, {
											...
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("select", {
												...
												children: platformOptions.map((opt) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
													value: opt.value,
													children: opt.label
												}, opt.value))
											})
