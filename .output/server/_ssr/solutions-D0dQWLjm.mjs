...
import { t as Route } from "./solutions-CO93LvXz.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/solutions-D0dQWLjm.js
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									children: "Features"
								}), sec.features?.map((feat, j) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Field, {
									label: "",
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
										value: feat,
										onChange: (v) => onChange(`sections.${i}.features.${j}`, v),
...
//#endregion
export { AdminSolutions as component };
